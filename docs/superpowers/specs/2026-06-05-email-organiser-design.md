...
For the latest operational handoff, read `docs/superpowers/context/2026-06-08-agent-handoff-context.md` and root `AGENTS.md`.

`Email Organiser` is an n8n workflow with two intended entry points:
